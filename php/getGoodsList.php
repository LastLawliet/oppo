<?php
	...
	while($query_row){
		$str = $str.'{ "gId":"'.$query_row[0].'","h3":"'.$query_row[1].'"
		,"type":"'.$query_row[2].'","price":"'.$query_row[3].'"
		,"goodsCount":"'.$query_row[4].'","h4":"'.$query_row[5].'"
		,"imgSrc":"'.$query_row[6].'","iColor":"'.$query_row[7].'"
		,"spanText":"'.$query_row[8].'","spanColor":"'.$query_row[9].'"
